...
def build_and_install_module(root_dir: pathlib.Path) -> bool:
    ...
    :return: True if the C code was built and installed correctly, False otherwise.
    """
    setup_path = root_dir / 'setup.py'

    build_proc = subprocess.Popen(
        ['python3', str(setup_path), 'build'], stdout=subprocess.PIPE, stderr=subprocess.PIPE, universal_newlines=True)
